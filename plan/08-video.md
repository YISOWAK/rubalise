...
|---|---|---|
| 0:00 - 0:30 | Trois photos, dix secondes chacune, dans `video/brut/` : la ligne de départ à Morgins, l'arche Finisher, la médaille. Fondu de l'une à l'autre | Last September I ran the SwissPeaks Marathon: forty-six kilometers in the Swiss Alps, eight and a half hours. I remember the volunteers as much as the trail. **[Ton souvenir vrai : une personne, un endroit, une heure. Une phrase.]** Someone had to put each of them in the right place at the right time. That someone works with a PDF, a form and a WhatsApp group, on their evenings. I built Rubalise for them. |
...
Autre accroche possible pour la scène 1, plus tendue : « At kilometer thirty of the SwissPeaks Marathon, I was done. What got me moving again was an aid station where people knew exactly what to do. [ton souvenir]. Now take two of them away, because two volunteers didn't show up that morning and nobody could fix the plan in time. That is the problem I wanted to solve. Not the race. The evenings before it. »
